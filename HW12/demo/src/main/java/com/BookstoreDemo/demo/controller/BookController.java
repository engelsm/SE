package com.BookstoreDemo.demo.controller;
...
import com.BookstoreDemo.demo.service.BookService;
...
public class BookController {
	...
	public ResponseEntity<Book> getLatestBook() {
		return new ResponseEntity<>(bookSer.fetchLatestBook(), HttpStatus.OK);
	}
	
	@GetMapping("/oldest")
	public ResponseEntity<Book> getOldestBook() {
		return new ResponseEntity<>(bookSer.fetchOldestBook(), HttpStatus.OK);
	}
